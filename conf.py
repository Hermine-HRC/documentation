...
project = u'HRC Documentation'
copyright = u'2025'
author = u'HRC members'
...
exclude_patterns = ['_build','_themes', 'README.md', '.*' ]
...
html_favicon = 'images/logo_48x48.png'
...
extlinks = {'projectfile': ('https://github.com/Hermine-HRC/documentation/blob/master/%s', 'filepath%s ')}
